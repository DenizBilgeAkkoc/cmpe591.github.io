...
class UNet(nn.Module):
    ...
    def forward(self, x, actions):
        ...
        b, _, h, w = x.shape  # b is batch size (1 in your case)
        
        # Reshape actions to [B, 4, H, W] to match spatial dimensions
        actions1 = actions.view(b, self.n_actions, 1, 1)
        actions1 = actions1.expand(-1, -1, h, w)  # Expand to match spatial dimensions
